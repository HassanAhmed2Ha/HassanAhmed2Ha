<div align="center">
  ...
  <a href="https://git.io/typing-svg">
    <img src="https://readme-typing-svg.demolab.com?font=JetBrains+Mono&weight=700&size=22&duration=2500&pause=800&color=0EA5E9&center=true&vCenter=true&repeat=true&width=700&height=45&lines=First-Year+Researcher+%E2%80%A2+Faculty+of+Agriculture;GCI+World+2026+%E2%80%A2+Matsuo+Lab%2C+University+of+Tokyo;Shipping+Explainable+AI+%26+Protein+Refinement+Pipelines" alt="Typing SVG" />
  </a>
...
I am a first-year undergraduate at the **Faculty of Agriculture**, Alexandria University, Egypt.

I don't just study biology — I build **deployed AI systems** that solve real problems in it. From explainable tumor classifiers to GPU-accelerated protein refinement pipelines and open-source tools for early researchers.
...
- **Backend:** FastAPI on Modal serverless GPUs (A10G) with async polling architecture to handle long-running MD jobs.
- **Repair Pipeline:** Two-pass PDBFixer strips non-standard residues, adds missing caps, and balances pH to 7.4.
- **Minimization:** OpenMM with AMBER14 + GBn2 implicit solvent and harmonic backbone restraints.
...
Clinical ML models are black boxes. Clinicians won't trust what they can't explain. NeuroScan accepts tumor measurements, predicts malignancy with high confidence, and generates **per-feature SHAP explanations** showing exactly which clinical markers drove the decision. This is a fully deployed production system.
...
- **The Scaler Bug Solved:** Fixed a critical deployment issue where the model predicted "Malignant" for everything by properly persisting the `StandardScaler` via `joblib` and applying `scaler.transform()` during inference.
- **Explainability:** `KernelExplainer` with lazy initialization to keep SHAP computation under 2 seconds.
- **Stack:** TensorFlow/Keras, SHAP, scikit-learn, FastAPI, Docker, HuggingFace Spaces.
...
<div align="left">
  <a href="https://hassan-ahmed-portfolio.vercel.app"><img src="https://img.shields.io/badge/▶_LIVE_SITE-0EA5E9?style=for-the-badge&labelColor=0D1117" alt="Live"/></a>&nbsp;
  <a href="https://github.com/HassanAhmed2Ha/Hassan-Ahmed-Portfolio"><img src="https://img.shields.io/badge/📦_SOURCE_CODE-7C3AED?style=for-the-badge&labelColor=0D1117" alt="Source"/></a>
</div>
...
<div align="center">
  ...
  <img src="https://github-readme-stats.vercel.app/api/top-langs/?username=HassanAhmed2Ha&layout=compact&theme=tokyonight&hide_border=true&langs_count=6&border_radius=10" alt="Languages" />
...
- 🇯🇵 **GCI World 2026 — Deep Learning** → Matsuo Laboratory, University of Tokyo
- 🇪🇺 **Erasmus+ Mentors Academy Trainee** → New Regeneration Project (EU)
- 🚀 **Galactic Problem Solver** → NASA International Space Apps Challenge
- 🤖 **Google Gemini Student Ambassador** → BasharSoft (800+ students impacted)
- 🔬 **Research Cohort Member** → Misr El Kheir Foundation
- 🧠 **Core Team, Data & Research** → Neuroverse Youth Power
...
<br/>
<a href="https://doi.org/10.5281/zenodo.17527523"><img src="https://img.shields.io/badge/DOI-10.5281%2Fzenodo.17527523-0EA5E9?style=flat-square" alt="DOI"/></a>

<br/>

**An Integrated Framework for Asteroid Impact Risk Assessment** · 2025
<br/>
<a href="https://doi.org/10.5281/zenodo.17527414"><img src="https://img.shields.io/badge/DOI-10.5281%2Fzenodo.17527414-7C3AED?style=flat-square" alt="DOI"/></a>

<br/>

**Integrated Consciousness: AI Impact on Human Cognitive Autonomy** · 2025
<br/>
<a href="https://doi.org/10.5281/zenodo.17527597"><img src="https://img.shields.io/badge/DOI-10.5281%2Fzenodo.17527597-F59E0B?style=flat-square" alt="DOI"/></a>
...
<a href="https://github.com/HassanAhmed2Ha"><img src="https://img.shields.io/badge/GitHub-HassanAhmed2Ha-F59E0B?style=for-the-badge&logo=github&logoColor=white&labelColor=0D1117" alt="GitHub"/></a>
